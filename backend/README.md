...
## Project Structure
    ...
    ├── achieving_suc_sess__37234  # Django project configurations
...
1. Clone this repo and `cd achieving_suc_sess__37234`
...
2. Clone this repo and `cd achieving_suc_sess__37234`
